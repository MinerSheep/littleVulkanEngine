...
// Screen-space placement lives in ui_object.hpp (RectTransformComponent)
// Point lights live in light_component.hpp (PointLightComponent)
// Neither one is part of the object/component core, so they are kept out of here
// and only the files that use them pay to include them
