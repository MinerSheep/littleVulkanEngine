...
void LveCamera::setOrthographicProjection(
    ...
    // To see the logic behind this, watch the end of https://www.youtube.com/watch?v=U0_ONQQ5ZNM&list=PL8327DO66nu9qYVKLDmdLW_84-yE4auCR&index=15&pp=iAQB
...
void LveCamera::setViewYXZ(glm::vec3 position, glm::vec3 rotation) {
  // this is rotating back the view Matrix I think?
